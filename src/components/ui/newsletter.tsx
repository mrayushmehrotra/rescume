      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="max-w-md w-full text-center md:text-left">
          ...
          <p className="text-muted-foreground mt-4 text-sm leading-relaxed">
            Get weekly AI resume-building tips, ATS updates, and career growth
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 mt-10">
            ...
            <button
              type="button"
              className="h-12 w-full sm:w-auto bg-primary hover:bg-primary/90 transition-all px-8 rounded-full text-primary-foreground font-bold text-sm whitespace-nowrap shadow-[0_0_20px_rgba(189,157,255,0.2)] active:scale-95"
            >
              Subscribe
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:max-w-lg">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-xs leading-relaxed">
              Deep dives into AI prompt engineering for resumes and interview
              preparation.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-xs leading-relaxed">
              Zero spam. We value your career data and your inbox's sanity.
              Unsubscribe anytime.
            </p>
          </div>
        </div>
