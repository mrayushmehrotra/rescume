            ...
            <div className="p-6 rounded-2xl border border-destructive/20 bg-destructive/5 space-y-4">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-destructive/70">
                  Once you delete your account, all your resumes and tailored
                  history will be permanently removed. This action is
                  irreversible.
                </p>
              </div>
              <button
                type="button"
                className="px-5 py-2.5 rounded-xl border border-destructive/30 text-destructive text-sm font-bold hover:bg-destructive hover:text-white transition-all"
              >
                Terminate Account
              </button>
            </div>
